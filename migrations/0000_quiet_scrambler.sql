...
--> statement-breakpoint
CREATE TABLE "macrosetor_detection" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "macrosetor_detection_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" text NOT NULL,
	"description" text,
...
--> statement-breakpoint
CREATE TABLE "macrosetor_keywords" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "macrosetor_keywords_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"macrosetor_id" integer NOT NULL,
...
ALTER TABLE "macrosetor_keywords" ADD CONSTRAINT "macrosetor_keywords_macrosetor_id_macrosetor_detection_id_fk" FOREIGN KEY ("macrosetor_id") REFERENCES "public"."macrosetor_detection"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint

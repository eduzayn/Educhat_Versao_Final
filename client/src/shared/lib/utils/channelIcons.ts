...
/**
 * Utilitário para ícones de canais sem duplicar estruturas
 */

// Componente simples para ícones SVG
...
export const getChannelIcon = (channel: string) => {
  const iconProps = { className: "w-3 h-3 text-current" };
  
  switch (channel?.toLowerCase()) {
    case 'whatsapp':
      return React.createElement(WhatsAppIcon, iconProps);
    case 'instagram':
      return React.createElement(InstagramIcon, iconProps);
    case 'facebook':
      return React.createElement(FacebookIcon, iconProps);
    case 'email':
      return React.createElement(EmailIcon, iconProps);
    case 'sms':
      return React.createElement(SmsIcon, iconProps);
    case 'website':
      return React.createElement(WebsiteIcon, iconProps);
    default:
      return React.createElement(WebsiteIcon, iconProps);
  }
};

    ...
    <Switch>
      ...
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/crm/deals" component={CRMPage} />
          <Route path="/crm/sales" component={CRMPage} />
          <Route path="/crm/activities" component={CRMPage} />
          <Route path="/crm/reports" component={CRMPage} />

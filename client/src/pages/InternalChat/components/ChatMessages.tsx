...
function InternalFileDisplay({ message }: { message: any }) {
  ...
  return (
    <div
      className="flex items-center gap-3 p-3 bg-black bg-opacity-10 rounded-lg max-w-xs cursor-pointer"
      onClick={handleDownload}
    >
      ...
      >
        <div className={`flex gap-3 ${isOwnMessage ? "flex-row-reverse" : ""}`}>
          ...
          >
            ...
            <div
              className={`inline-block max-w-lg p-3 rounded-lg text-sm leading-relaxed ${
                isOwnMessage
                ...
                <div className="flex items-center gap-2 p-2 bg-blue-50 border border-blue-200 rounded-md mb-2">
                  ...
                  <span className="text-blue-800">
                    ...
                    {message.reminderDate
                      ? format(message.reminderDate, "dd/MM/yyyy HH:mm")
                      : "data não definida"}
                  </span>
                </div>
              )}

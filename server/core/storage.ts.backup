...
// Import da nova estrutura modular para uso futuro
import { detectMacrosetor } from "../storage/utils/macrosetorUtils";
import { detectCourses } from "../storage/utils/courseUtils";
...
// Classe wrapper para manter compatibilidade com o código existente
// Delega todas as operações para a nova estrutura modular

...
/**
 * Módulo de Gestão de Funções (Roles)
 * Responsabilidades:
 * - CRUD de funções
 * - Associação de permissões a funções
 * - Gerenciamento de role-permissions
 */
export function registerRoleRoutes(app: Express) {
  ...
  // Atualizar permissões de uma função (método PUT legacy)

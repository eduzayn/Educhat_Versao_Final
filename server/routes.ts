...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // First contacts endpoint removed - using the more complete implementation below
  ...
  // First contacts/:id endpoint removed - using identical implementation later
  ...
  // First reply-message implementation removed - using the more complete one later

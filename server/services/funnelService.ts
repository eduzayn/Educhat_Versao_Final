import { FunnelOperations } from './funnelOperations';
import { FunnelDealOperations } from './funnelDealOperations';
...
export class FunnelService {
  private operations: FunnelOperations;
  private dealOperations: FunnelDealOperations;

  constructor() {
    this.operations = new FunnelOperations();
    this.dealOperations = new FunnelDealOperations();
  }
  ...
  async createFunnelForTeam(teamId: number): Promise<boolean> {
    return this.operations.createFunnelForTeam(teamId);
  }
  ...
  async createMissingFunnels(): Promise<{ created: number; details: string[] }> {
    return this.operations.createMissingFunnels();
  }
  ...
  async updateDealsToCorrectFunnels(): Promise<{ updated: number; details: string[] }> {
    return this.dealOperations.updateDealsToCorrectFunnels();
  }
  ...
  async getFunnelByTeamType(teamType: string) {
    return this.operations.getFunnelByTeamType(teamType);
  }
  ...
  async getInitialStageForTeamType(teamType: string): Promise<string> {
    return this.operations.getInitialStageForTeamType(teamType);
  }
   ...
   */
  async getAllFunnels() {
    return this.operations.getAllFunnels();
  }
}
